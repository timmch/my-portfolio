<template>
  <div>
    <div class="bg-blue-600 pt-24 pb-16">
      <div class="max-w-lg text-center m-auto">
        <div>
          <img
            class="h-40 md:h-56 rounded-full border-gray-100 border-4 m-auto shadow-lg"
            src="/img/Tim_Profile.jpg"
            alt="Tim Profile"
          />

          <h1 class="font-bold text-4xl text-gray-100 leading-tight mt-6">
            Tim McHugh
          </h1>
          <h2 class="text-gray-100">My professional portfolio</h2>
        </div>
      </div>
    </div>
    <div class="py-16 px-4 md:p-32 text-center">
